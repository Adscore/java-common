...
public class PhpUnserializer {
    ...
    public PhpUnserializer(String data) {
        this.data = data;
        this.index = 0;
    }
    ...
    private String parseBoolean() {
        ...
        index += 2; // Move past the boolean value and the semicolon
    ...
    private String parseString() {
        ...
        index = colonIndex + 2; // Move past the length and the opening quote
        String str = data.substring(index, index + length);
        index += length + 2; // Move past the string and the closing quote
        return str;
    }
